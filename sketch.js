...
// ===== 影片路徑 =====
// 這裡一定要和 GitHub repo 的實際檔名完全一致（包含大小寫）
  ...
  drawFrame() {
    ...
    if (flicker > 0.02) {
      ...
      for (let i = 0; i < 3; i++) {
        ...
        image(this.frameImg, this.frameX + jitterX, this.frameY + jitterY, this.frameW, this.frameH);
      }
